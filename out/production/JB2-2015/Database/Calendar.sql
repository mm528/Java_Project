...
# Database: Calendar
# Generation Time: 2015-05-12 18:03:01 +0000
# ************************************************************
...
VALUES
	(2,1,'Fun Boy Games','Some kind of activities...','2015-04-28','08:00:00','16:00:00','WQ565',0),
...
INSERT INTO `Notification` (`notificationID`, `eventID`)
VALUES
	(1,2),
	(2,3),
	(3,4);
...
INSERT INTO `Reminder` (`userID`, `eventID`, `reminderTime`)
VALUES
	(1,2,3),
	(1,2,4),
	(2,3,1);
...
VALUES
	(1,0,'Guyqw','fwefwef','Darren','VissionWard','email@gmail.com',734455345,NULL),
...
--
-- Dumping routines (PROCEDURE) for database 'Calendar'
--
DELIMITER ;;
...
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `create_event`(IN pr_userID smallint(255),
...
/*!50003 SET SESSION SQL_MODE="STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `delete_event`(IN pr_eventID int(255),
...
/*!50003 SET SESSION SQL_MODE="STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `delete_invite`(IN pr_userID smallint(255),
...
/*!50003 SET SESSION SQL_MODE="STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `insert_user`(IN pr_isSuperUser tinyint(1),
